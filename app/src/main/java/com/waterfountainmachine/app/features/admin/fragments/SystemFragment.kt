...
class SystemFragment : Fragment() {
    ...
    private fun updateApiMode(useRealApi: Boolean) {
        lifecycleScope.launch {
            try {
                AppLog.i(TAG, "updateApiMode() called with useRealApi=$useRealApi")
                
                // useRealApi = true means Real API mode
                // useMockMode = false means Real API mode
                val useMockMode = !useRealApi
                
                AppLog.i(TAG, "Saving preference: useMockMode=$useMockMode")
                ...
                AppLog.i(TAG, "API mode preference saved: $modeName")
    ...
    private fun executeRestart() {
        ...
        AppLog.w(TAG, "System restart initiated - killing process for clean restart")
        ...
        lifecycleScope.launch {
            try {
                ...
                if (intent != null) {
                    ...
                    AppLog.i(TAG, "Starting new app instance...")
                    ...
                    AppLog.i(TAG, "Killing process to complete restart")
